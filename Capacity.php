...
/**
 * An individual capacity item to be part of an CapacityArray for a Page
 *
 */
class Capacity extends WireData {

	const dateFormat = 'Y-m-d';

	/**
	 * We keep a copy of the $page that owns this capacity so that we can follow
	...
	public function __construct() {
		...
		// define the fields that represent our capacity (and their default/blank values)
		$this->set('date', 0);
		$this->set('location', '');
		$this->set('notes', '');
	}
	...
	/**
	 * Set a value to the capacity: date, location or notes
	 *
	 */
	...
	/**
	 * Retrieve a value from the capacity: date, location or notes
	 *
	 */
	...
	/**
	 * Just for fun: returns true if the capacity has already past
	 *
	 */
	...
	/**
	 * Provide a default rendering for an capacity
	 *
	 */
	...
	/**
	 * Return a string representing this capacity
	 *
	 */
